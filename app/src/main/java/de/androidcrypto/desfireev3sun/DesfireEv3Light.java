...
import static de.androidcrypto.desfireev3sun.Utils.hexStringToByteArray;
import static de.androidcrypto.desfireev3sun.Utils.intTo2ByteArrayInversed;
...
public class DesfireEv3Light {
    ...
    public static final byte[] NDEF_APPLICATION_IDENTIFIER = hexStringToByteArray("010000"); // this is the AID for NDEF application
    public static final byte[] NDEF_ISO_APPLICATION_IDENTIFIER = hexStringToByteArray("10E1"); // this is the ISO AID for NDEF application
    public static final byte[] NDEF_APPLICATION_DF_NAME = hexStringToByteArray("D2760000850101"); // this is the Data File name for NDEF application
    public static final byte NDEF_FILE_01_NUMBER = (byte) 0x01;
    public static final byte[] NDEF_FILE_01_ISO_NAME = hexStringToByteArray("03E1");
    //public static final byte[] NDEF_FILE_01_ACCESS_RIGHTS = Utils.hexStringToByteArray("EEEE"); // free access to all rights
    public static final byte[] NDEF_FILE_01_ACCESS_RIGHTS = hexStringToByteArray("E0EE"); // free access to all rights except CAR (key 0)
    public static final int NDEF_FILE_01_SIZE = 15;
    private byte[] NDEF_FILE_01_CONTENT_CONTAINER = hexStringToByteArray("000F20003A00340406E10401000000"); // 256 byte
    public static final byte NDEF_FILE_02_NUMBER = (byte) 0x02;
    public static final byte[] NDEF_FILE_02_ISO_NAME = hexStringToByteArray("04E1");
    public static final byte[] NDEF_FILE_02_ACCESS_RIGHTS = hexStringToByteArray("00EE"); // free access for reading and writing, an authentication is needed for all other accesses
