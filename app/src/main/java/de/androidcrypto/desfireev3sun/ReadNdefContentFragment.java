...
import static de.androidcrypto.desfireev3sun.MainActivity.APPLICATION_KEY_MASTER_AES;
 ...
 * Use the {@link ReadNdefContentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReadNdefContentFragment extends Fragment implements NfcAdapter.ReaderCallback {
    private static final String TAG = ReadNdefContentFragment.class.getName();
    ...
    public ReadNdefContentFragment() {
    ...
    public static ReadNdefContentFragment newInstance(String param1, String param2) {
        ReadNdefContentFragment fragment = new ReadNdefContentFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_read_ndef_content, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {

        output = getView().findViewById(R.id.etReadNdefContentOutput);
        outputLayout = getView().findViewById(R.id.etReadNdefContentOutputLayout);

        rgStatus = getView().findViewById(R.id.rgReadNdefContentStatus);
        rbReadNdefContentNoAuth = getView().findViewById(R.id.rbReadNdefContentNoAuth);
        rbReadNdefContentAuthKey0 = getView().findViewById(R.id.rbReadNdefContentAuthKey0);
        rbReadNdefContentAuthKey0Changed = getView().findViewById(R.id.rbReadNdefContentAuthKey0Changed);
    ...
    private void readNdefContent() {
        ...
        if (content != null) {
            ...
            writeToUiAppendBorderColor("read the content from fileId 0x02 FAILURE with error code: " + EV3.getErrorCode(responseData) + ", aborted", COLOR_RED);
        }
    }
