...
public class DesfireD40Light {
    ...
    public byte[] tripleDesSendModeDecryption(byte[] tdesKeyExt, byte[] ciphertextExt) {
        ...
        byte[] ct1XoredDecrypted = de.androidcrypto.desfireev3sun.TripleDES.decrypt(tdesKey, ct1Xored, 0, 8);
        ...
        byte[] ct2XoredDecrypted = de.androidcrypto.desfireev3sun.TripleDES.decrypt(tdesKey, ct2Xored, 0, 8);
